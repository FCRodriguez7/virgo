...
docReady(function() {
    (function (window, document, version, callback) {
        ...
        function app(element, isHomeDomain, isOnlyInstance) {
            var socket, $app, $img, $appFrame, manifestUri, collectionIndex, manifestIndex, sequenceIndex, canvasIndex, defaultToFullScreen, isLightbox, xywh, rotation, config, jsonp, locale, isFullScreen, dimensions, top, left, lastScroll, reload, rightsWrapper;
            ...
            rightsWrapper = encodeURIComponent($app.attr('data-rightswrapper'));
            thumbnail = encodeURIComponent($app.attr('data-thumbnail'));
